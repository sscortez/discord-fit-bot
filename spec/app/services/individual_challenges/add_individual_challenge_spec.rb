...
RSpec.describe IndividualChallenges::AddIndividualChallenge do
  describe '#new' do
  ...
  describe '#call' do
    context 'when valid arguments are passed' do
      it 'creates a new individual challenge record' do
        ...
        end.to change(IndividualChallenge, :count).by(1)
      end
    end
